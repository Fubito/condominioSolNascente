...
public class FuncionarioUpdateScreen {
    ...
    void inserirClicked(MouseEvent event) throws IOException{
        ...
        CondominioConnector.updateFuncionario(idFuncionario, nome, cargoId, telefone);
    ...
    void initialize() {
        ...
        assert updateButton != null : "fx:id=\"updateButton\" was not injected: check your FXML file 'condominoInsertScreen.fxml'.";
        assert telefoneTextField != null : "fx:id=\"telefoneTextField\" was not injected: check your FXML file 'condominoInsertScreen.fxml'.";
        assert idFuncionarioTextField != null : "fx:id=\"idFuncionarioTextField\" was not injected: check your FXML file 'condominoInsertScreen.fxml'.";
